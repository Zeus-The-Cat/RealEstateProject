    ...
    app.post('/myaction', function (req, res) {
        ...
        */
        ...
        if (req.body.p_type.toString() != 0 && req.body.p_type.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[4] = { "properties.PARCEL_TYP": s1 };
        } else {
            arr[4] = {};
        }
        ...
        if (req.body.b_page.toString() != 0 && req.body.b_page.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[6] = { "properties.BOOK_PAGE": s1 };
        } else {
            arr[6] = {};
        }
        if (req.body.p_year.toString() !== "" && req.body.p_year.toString() != ',') {
            //console.log("you've entered city");
            s1 = parseInt(req.body.p_year.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[7] = { "properties.PARCEL_YEA": s1 };
        } else {
            arr[7] = {};
        }
        arr[7] = {}
        if (req.body.p_own.toString() != 0 && req.body.p_own.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[8] = { "properties.PARCEL_OWN": s1 };
        } else {
            arr[8] = {};
        }
        if (req.body.d_own.toString() != 0 && req.body.d_own.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[9] = { "properties.DEEDED_OWN": s1 };
        } else {
            arr[9] = {};
        }
        ...
        if (req.body.t_d.toString() != 0 && req.body.t_d.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[12] = { "properties.TRANSFER_D": s1 };
        } else {
            arr[12] = {};
        }
        ...
        if (req.body.s_amnt.toString() !== "" && req.body.s_amnt.toString() != ',') {
            //console.log("you've entered city");
            s1 = parseInt(req.body.s_amnt.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[13] = { "properties.SALES_AMOU": s1 };
        } else {
            arr[13] = {};
        }
        ...
        if (req.body.p_street.toString() != 0 && req.body.p_street.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[15] = { "properties.PAR_STREET": s1 };
        } else {
            arr[15] = {};
        }
        if (req.body.p_suf.toString() != 0 && req.body.p_suf.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[16] = { "properties.PAR_SUFFIX": s1 };
        } else {
            arr[16] = {};
        }
        ...
        if (req.body.p_add_a.toString() != 0 && req.body.p_add_a.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[19] = { "properties.PAR_ADDR_A": s1 };
        } else {
            arr[19] = {};
        }
        if (req.body.m_name.toString() != 0 && req.body.m_name.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[20] = { "properties.MAIL_NAME": s1 };
        } else {
            arr[20] = {};
        }
        if (req.body.m_add.toString() != 0 && req.body.m_add.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[21] = {"properties.MAIL_ADDR_": s1};
        } else {
            arr[21] = {};
        }
        if (req.body.m_city.toString() != 0 && req.body.m_city.toString() != ',') {
            ...
            //s1 = s1.substr(1, s1.length);
            arr[22] = { "properties.MAIL_CITY": s1 };
        } else {
            arr[22] = {};
        }
        if (req.body.m_state.toString() != 0 && req.body.m_state.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[23] = { "properties.MAIL_STATE": s1 };
        } else {
            arr[23] = {};
        }        
        ...
        if (req.body.t_luc_de.toString() != 0 && req.body.t_luc_de.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[26] = {"properties.TAX_LUC_DE": s1};
        } else {
            arr[26] = {};
        }
        if (req.body.z_code.toString() != 0 && req.body.z_code.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[27] = {"properties.ZONING_COD": s1};
        } else {
            arr[27] = {};
        }
        if (req.body.z_use.toString() != 0 && req.body.z_use.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[28] = {"properties.ZONING_USE": s1};
        } else {
            arr[28] = {};
        }
        if (req.body.p_cat.toString() != 0 && req.body.p_cat.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[29] = {"properties.PROPERTY_C": s1};
        } else {
            arr[29] = {};
        }
        if (req.body.t_dis.toString() != 0 && req.body.t_dis.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[30] = {"properties.TAX_DISTRI": s1};
        } else {
            arr[30] = {};
        }
        if (req.body.neigh.toString() != 0 && req.body.neigh.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[31] = {"properties.NEIGHBORHO": s1};
        } else {
            arr[31] = {};
        }
        if (req.body.r_type.toString() != 0 && req.body.r_type.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[32] = {"properties.ROAD_TYPE": s1};
        } else {
            arr[32] = {};
        }
        ...
        if (req.body.elec.toString() != 0 && req.body.elec.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[36] = {"properties.ELECTRICIT": s1};
        } else {
            arr[36] = {};
        }
        if (req.body.t_year.toString() !== "" && req.body.t_year.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.t_year.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[37] = {"properties.TAX_YEAR": s1};
        } else {
            arr[37] = {};
        }
        if (req.body.cert1.toString() !== "" && req.body.cert1.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.cert1.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[38] = {"properties.CERT1": s1};
        } else {
            arr[38] = {};
        }
        ...
        if (req.body.cert2.toString() !== "" && req.body.cert2.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.cert2.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[39] = {"properties.CERT2": s1};
        } else {
            arr[39] = {};
        }
        if (req.body.cert3.toString() !== "" && req.body.cert3.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.cert3.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[40] = {"properties.CERT3": s1};
        } else {
            arr[40] = {};
        }
        if (req.body.cert4.toString() !== "" && req.body.cert4.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.cert4.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[41] = {"properties.CERT4": s1};
        } else {
            arr[41] = {};
        }
            arr[42] = {};
        ...
        if (req.body.cert6.toString() !== "" && req.body.cert6.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.cert6.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[43] = {"properties.CERT6": s1};
        } else {
            arr[43] = {};
        }
        if (req.body.cert7.toString() !== "" && req.body.cert7.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.cert7.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[44] = {"properties.CERT7": s1};
        } else {
            arr[44] = {};
        }
        ...
        if (req.body.cert8.toString() !== "" && req.body.cert8.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.cert8.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[45] = {"properties.CERT8": s1};
        } else {
            arr[45] = {};
        }
        if (req.body.cert10.toString() !== "" && req.body.cert10.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.cert10.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[46] = {"properties.CERT10": s1};
        } else {
            arr[46] = {};
        }
        if (req.body.cert11.toString() !== "" && req.body.cert11.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.cert11.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[47] = {"properties.CERT11": s1};
        } else {
            arr[47] = {};
        }
        ...
        if (req.body.cert12.toString() !== "" && req.body.cert12.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.cert12.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[48] = {"properties.CERT12": s1};
        } else {
            arr[48] = {};
        }
        if (req.body.gcert1.toString() !== "" && req.body.gcert1.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.gcert1.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[49] = {"properties.GCERT1": s1};
        } else {
            arr[49] = {};
        }
        ...
        if (req.body.gcert2.toString() !== "" && req.body.gcert2.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.gcert2.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[50] = {"properties.GCERT2": s1};
        } else {
            arr[50] = {};
        }
        ...
        if (req.body.gcert3.toString() !== "" && req.body.gcert3.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.gcert3.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[51] = {"properties.GCERT3": s1};
        } else {
            arr[51] = {};
        }
        if (req.body.r_bld_c.toString() !=="" && req.body.r_bld_c.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.r_bld_c.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[52] = {"properties.RES_BLDG_C": s1};
        } else {
            arr[52] = {};
        }
        if (req.body.t_res.toString() !== "" && req.body.t_res.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.t_res.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[53] = {"properties.TOTAL_RES_": s1};
        } else {
            arr[53] = {};
        }
        if (req.body.t_res1.toString() !== "" && req.body.t_res1.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.t_res1.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[54] = {"properties.TOTAL_RES1": s1};
        } else {
            arr[54] = {};
        }
        if (req.body.c_bld_c.toString() !== "" && req.body.c_bld_c.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.c_bld_c.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[55] = {"properties.COM_BLDG_C": s1};
        } else {
            arr[55] = {};
        }
        if (req.body.t_com.toString() != "" && req.body.t_com.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.t_com.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[56] = {"properties.TOTAL_COM_": s1};
        } else {
            arr[56] = {};
        }
        if (req.body.com_liv.toString() !== "" && req.body.com_liv.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.com_liv.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[57] = {"properties.COM_LIVING": s1};
        } else {
            arr[57] = {};
        }
        if (req.body.t_leg.toString() !== "" && req.body.t_leg.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.t_leg.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[58] = {"properties.TOTAL_LEGA": s1};
        } else {
            arr[58] = {};
        }
        if (req.body.t_square.toString() !== "" && req.body.t_square.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.t_square.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[59] = {"properties.TOTAL_SQUA": s1};
        } else {
            arr[59] = {};
        }
        if (req.body.t_acre.toString() !== "" && req.body.t_acre.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[60] = {"properties.TOTAL_ACRE": s1};
        } else {
            arr[60] = {};
        }
        ...
        if (req.body.p_city2.toString() != 0 && req.body.p_city2.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[66] = {"properties.PAR_CITY2": s1};
        } else {
            arr[66] = {};
        }
        if (req.body.units.toString() !== "" && req.body.units.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.units.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[67] = {"properties.Units": s1};
        } else {
            arr[67] = {};
        }
        if (req.body.units2.toString() !== "" && req.body.units2.toString() != ',') {
            //console.log("you've entered zip code");
            s1 = parseInt(req.body.units2.toString());
            //s1 = s1.substr(0, s1.length-1);
            arr[68] = {"properties.Units2": s1};
        } else {
            arr[68] = {};
        }
        if (req.body.p_own2.toString() != 0 && req.body.p_own2.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[69] = {"properties.PARCL_OWN2": s1};
        } else {
            arr[69] = {};
        }
        if (req.body.p_own3.toString() != 0 && req.body.p_own3.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[70] = {"properties.PARCL_OWN3": s1};
        } else {
            arr[70] = {};
        }
        ...
        if (req.body.p_loc.toString() != 0 && req.body.p_loc.toString() != ',') {
            ...
            //s1 = s1.substr(0, s1.length-1);
            arr[74] = {"properties.PARCELLOC": s1};
        } else {
            arr[74] = {};
        }
